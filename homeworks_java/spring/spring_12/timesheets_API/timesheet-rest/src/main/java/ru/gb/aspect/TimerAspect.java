...
public class TimerAspect {
  ...
  private static final org.apache.logging.log4j.Logger log = org.apache.logging.
          log4j.LogManager.getLogger(TimerAspect.class);
...
//  }
  ...
  public Object aroundTimesheetServiceMethods(ProceedingJoinPoint pjp) throws Throwable {
    ...
    try {
     ...
     log.info("TimesheetService#{}, duration = {}ms, {} = {}",
             pjp.getSignature().getName(),
             duration,
             pjp.getArgs()[0].getClass(), pjp.getArgs()[0]);// method.getDefaultValue()); //pjp.getArgs()[0]);
