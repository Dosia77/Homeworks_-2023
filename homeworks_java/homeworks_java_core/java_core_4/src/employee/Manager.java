...
public class Manager extends Employee {
    ...
    public Manager(Genders gender,String firstName, String midName, String lastName, String phone, String position, int salary, LocalDate birthDate) {
        super(gender, firstName, midName, lastName, phone, position, salary, birthDate);
    }
